import { mulberry32, xmur3 } from "src/modules/utils/hash";
import { ChampionshipState, ChampionshipPhase, Participant, Judge, Vote, Round, Like } from "src/core/championship/domain/championship.types";
