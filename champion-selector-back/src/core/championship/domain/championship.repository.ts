...
import { AddParticipantEvent, RemoveParticipantEvent, AddJudgeEvent, RemoveJudgeEvent, UpdateJudgeEvent, StartChampionshipEvent, VoteInParticipantEvent, RestartChampionshipEvent, LikeParticipantEvent } from "src/core/championship/domain/championship.domain.events";
import { Participant, Judge } from "src/core/championship/domain/championship.types";
