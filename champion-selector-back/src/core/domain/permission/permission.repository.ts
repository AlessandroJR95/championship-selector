...
import { AddInviteTokenEvent, AddOwnerTokenEvent, AddUserTokenEvent, AssignJudgeIDToTokenEvent, RemoveTokenEvent, UseInviteTokenEvent } from "./permission.domain.events";
